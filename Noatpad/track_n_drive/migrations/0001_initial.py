# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-11-28 09:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_repair', models.DateField(default=datetime.date(2017, 11, 28), help_text='Enter a date for this repair')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_made', models.DateField(default=datetime.date(2017, 11, 28), help_text='Enter the date of repair')),
        ...
        migrations.AddField(
            model_name='car',
            name='profile',
            field=models.ForeignKey(help_text='Which user owns this car?', on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.Profile'),
        ),
    ]
