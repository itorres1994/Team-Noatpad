# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-11-01 00:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_made', models.DateField(default=datetime.date(2017, 10, 31))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.IntegerField(default=1, help_text='How many times should you be reminded?')),
                ('reminder', models.CharField(blank=True, choices=[('w', 'Weeks Before'), ('d', 'Days Before')], default='w', help_text='Alert Type', max_length=1)),
                ('notify', models.ForeignKey(help_text='Notification', on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.Notifications')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('information_name', models.CharField(default='info name', help_text='Information Category', max_length=200)),
                ('information_contents', models.CharField(default='info content', help_text='Information to Add', max_length=200)),
                ('user_info', models.ForeignKey(blank=True, help_text='User', null=True, on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.User')),
            ],
        ),
        migrations.AddField(
            model_name='techaddedinfo',
            name='tech',
            field=models.ForeignKey(blank=True, help_text='Technician', null=True, on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.Technician'),
        ),
        migrations.AddField(
            model_name='settings',
            name='user_ins',
            field=models.ForeignKey(help_text='User Settings', on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.User'),
        ),
        migrations.AddField(
            model_name='repair',
            name='technician',
        ...
        migrations.AddField(
            model_name='phone',
            name='user_ins',
            field=models.ForeignKey(blank=True, help_text='User Phone', null=True, on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.User'),
        ),
        migrations.AddField(
            model_name='notifications',
            name='user_ins',
            field=models.ForeignKey(help_text='Notify User', on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.User'),
        ),
        migrations.AddField(
            model_name='license',
            name='user_ins',
            field=models.ForeignKey(blank=True, help_text='User License', null=True, on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.User'),
        ),
        migrations.AddField(
            model_name='insurance',
            name='user_ins',
            field=models.ForeignKey(blank=True, help_text='User Insurance', null=True, on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.User'),
        ),
        migrations.AddField(
            model_name='futurerepair',
            name='notify',
            field=models.ForeignKey(help_text='Notification association', on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.Notifications'),
        ),
        migrations.AddField(
            model_name='futurerepair',
            name='technician',
        ...
        migrations.AddField(
            ...
            name='notify',
            field=models.ForeignKey(help_text='Notification', on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.Notifications'),
        ),
        migrations.AddField(
            model_name='emailtimings',
            name='setting_ref',
        ...
        migrations.AddField(
            model_name='email',
            name='user_ins',
            field=models.ForeignKey(blank=True, help_text='User Email', null=True, on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.User'),
        ),
        migrations.AddField(
            model_name='car',
            name='user_ins',
            field=models.ForeignKey(help_text='Which user owns this car?', on_delete=django.db.models.deletion.CASCADE, to='track_n_drive.User'),
        ),
    ]
