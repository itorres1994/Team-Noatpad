...
urlpatterns = [
    ...
    url(r'^edit-repair-(?P<unique_id>[-\w]+)/(?P<car_id>[-\w]+)$', views.edit_repair, name='edit_repairs'),
    url(r'^[-\w]+/edit-repair-(?P<unique_id>[-\w]+)/(?P<car_id>[-\w]+)$', views.edit_repair, name='edit_repairs'),
