...
urlpatterns = [
    ...
    url(r'^car-prof-(?P<unique_id>[-\w]+)/add-future-repair$', views.add_future_repair, name='add_future_repairs'),
    url(r'^[-\w]+/edit-future-repair-(?P<unique_id>[-\w]+)$', views.edit_future_repair, name='add_future_repairs'),
    url(r'^edit-future-repair-(?P<unique_id>[-\w]+)/(?P<car_id>[-\w]+)$', views.done_future_repair,
        name='add_future_repairs'),
    url(r'^[-\w]+/edit-future-repair-(?P<unique_id>[-\w]+)/(?P<car_id>[-\w]+)$', views.done_future_repair,
        name='add_future_repairs'),
